...
$sql = "select * from products where category = 'ammo' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where category = 'ammo'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Ammunition | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality ammo for all of your hunting gear - FREE shipping and returns on everything'>
    ...
    <div class="container products">
        ...
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="ammoFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
