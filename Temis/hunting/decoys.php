...
$sql = "select * from products where category = 'decoys' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where category = 'decoys'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Decoys | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality decoys for your next hunting trip - FREE shipping and returns on everything'>
    ...
    <div class="container products">
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Decoys</li>
                        </ol>
                    </nav>
                </div>
            </div>
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="decoysFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
