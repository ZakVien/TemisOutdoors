...
$sql = "select * from products where category = 'knives' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where category = 'knives'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Knives | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality knives to add to your hunting gear - FREE shipping and returns on everything'>
    ...
    <div class="container products">
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Knives</li>
                        </ol>
                    </nav>
                </div>
            </div>
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="knivesFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
