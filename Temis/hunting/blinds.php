...
$sql = "select * from products where category = 'blinds' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where category = 'blinds'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Hunting Blinds | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality blinds for your next archery or hunting trip - FREE shipping and returns on everything'>
    ...
    <div class="container products">
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="blindsFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Blinds</li>
                        </ol>
                    </nav>
                </div>
            </div>
