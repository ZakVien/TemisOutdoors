...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'archery'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Archery | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer archery supplies at affordable prices - FREE shipping and returns on everything'>
    ...
    <div class="container products">
            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Archery</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="archeryFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    <h3>Refine Results</h3>
                    <br>
                    <label for="category">Category</label>
                    <br>
                    <?php
                        $sql_category = "select category from products where section = 'archery' order by category";
