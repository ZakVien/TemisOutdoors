...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'clothing'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Clothing | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer quality clothing products such as Carhartt, Columbia, and our in-house brand Temis - FREE shipping and returns on everything'>
        ...
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="clothingFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    ...
                    <br>
                    <?php
                        $sql_category = "select category from products where section = 'clothing' order by category";
                    ...
                    <a href="clothing/<?php echo strtolower($ucURL) . ".php";?>"><?php echo $uc; ?></a><br>
                    <?php }
                        };
                        ?>
                    <br>
