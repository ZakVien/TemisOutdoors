...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'hunting'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Affordable Hunting | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis offers affordable hunting supplies and equipment at affordable prices - FREE shipping and returns on everything'>
    ...
    <div class="container products">
            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Hunting</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="huntingFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    ...
                    <br>
                    <?php
                        $sql_category = "select category from products where section = 'hunting' order by category";
                    ...
                    <?php
                            ...
                            foreach($categoryArray as $uc){
                                $ucURL = str_replace(' ', '-', $uc);?>
                    <a href="hunting/<?php echo strtolower($ucURL) . ".php";?>"><?php echo $uc; ?></a><br>
                    <?php }
                        };
                        ?>
                    <br>
