...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'gardening'
order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Gardening Equipment | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis offers affordable landscaping and gardening supplies at affordable prices - FREE shipping and returns on everything'>
    ...
    <div class="container products">
        ...
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="gardeningFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    <h3>Refine Results</h3>
                    <br>
                    <label for="category">Category</label>
                    <br>
                    <?php
                        $sql_category = "select category from products where section = 'gardening' order by category";
                    ...
                    <a href="gardening/<?php echo strtolower($ucURL) . ".php";?>"><?php echo $uc; ?></a><br>
                    <?php }
                        };
                        ?>
                    <br>
