...
<head>
    ...
    <title>Clearance Items | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis has plenty of quality items on clearance. We sell everything from archery supplies to landscaping - FREE shipping and returns on everything'>
    ...
    <div class="container products">
        ...
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="clearanceFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    <h3>Refine Results</h3>
                    <br>
                    <label for="category">Category</label>
                    <br>
                    <?php
                        $sql_category = "select section, category from clearance 
                                        inner join products
                                        on clearance.productId = products.productId
                                        order by category";
                        ...
                        if($sql_category->execute()){
                            ...
                            foreach($categoryitem as $c){
                                $section = str_replace(' ', '-', $c["section"]);
                                $category = str_replace(' ', '-', $c["category"]);
                                $categoryURL = '<a href="'.strtolower($section . '/' . $category).'.php">'.$c["category"].'</a><br>';
                                array_push($urlArr, $categoryURL);
                            }
                            $urlArr = array_unique($urlArr);
                            foreach($urlArr as $urls){
                                echo $urls;
                            }
                        }
                        ?>
                    ...
                    <div class="card h-100 mb-3">
                        ...
                        <div class="card-body pb-0 pt-0 productPrice d-flex align-items-end">
                            <div class="text-center w-100">
                                ...
                                <h6><b class="strikethrough">$<?php echo round($p["price"] * 1.17, 2); ?></b></h6>
                            </div>
                        </div>
