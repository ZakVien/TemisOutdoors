...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'archery' and category = 'cases'";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Bow Cases | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality bow cases to protect your archery equipment - FREE shipping and returns on everything'>
