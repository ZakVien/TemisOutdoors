...
$sql = "select * from products where section = 'archery' and 
category = 'arrowheads' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'archery' and category='arrowheads'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Arrowheads | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality arrowheads to add to your archery equipment - FREE shipping and returns on everything'>
    ...
    <div class="container products">
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../archery.php">Archery</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Arrowheads</li>
                        </ol>
                    </nav>
                </div>
            </div>
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="bowsFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    ...
                    <br>
                    <button type="submit" value="submit" name="submit" id="updateButton" class="btn btn-warning">Update changes</button>
                    <br>
                    <br>
                    ...
                    <div class="card h-100 mb-3">
                        ...
                        <div class="text-center">
                            <div class="mb-sm-2 mb-lg-2">
                                <form id="view<?php echo $p['productId'];?>" method="POST" action="<?php echo "../../".$p["url"]; ?>">
