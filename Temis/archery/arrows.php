...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'archery' and category = 'arrows' 
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Arrows | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality arrows to add to your archery equipment - FREE shipping and returns on everything'>
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Arrows</li>
                        </ol>
                    </nav>
                </div>
            </div>
