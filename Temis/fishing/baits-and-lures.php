...
$sql = "select * from products where section = 'fishing' and 
category = 'baits and lures' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'fishing' and category = 'baits and lures'
order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Baits &amp; Lures | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality fishing bait and lures to add to your fishing gear - FREE shipping and returns on everything'>
...
<body>
    ...
    <div class="container products">
            <div class="row">
                <div class="col">
                    <h1>Baits and Lures</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="../fishing.php">Fishing</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Baits and Lures</li>
                        </ol>
                    </nav>
                </div>
            </div>
