...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'fishing' and category = 'fishing rods'";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Fishing Rods | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality fishing rods to add to your fishing gear - FREE shipping and returns on everything'>
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Fishing Rods</li>
                        </ol>
                    </nav>
                </div>
            </div>
