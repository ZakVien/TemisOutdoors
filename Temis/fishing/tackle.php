...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'fishing' and category = 'tackle'";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Fishing Tackle | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality tackle to add to your fishing gear - FREE shipping and returns on everything'>
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tackle</li>
                        </ol>
                    </nav>
                </div>
            </div>
