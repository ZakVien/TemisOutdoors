...
$sql = "select * from products where category = 'ghillie suits' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where category = 'ghillie suits'
order by manufacturer, name";
$stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Ghillie Suits | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality ghillie suits to help you on the hunt - FREE shipping and returns on everything'>
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ghillie Suits</li>
                        </ol>
                    </nav>
                </div>
            </div>
