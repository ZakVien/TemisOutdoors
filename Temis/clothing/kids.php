...
<head>
    ...
    <title>Kids Clothing | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content="Temis is proud to offer affordable, high-quality kids/childrens clothing to add to your family's outdoor lifestyle - FREE shipping and returns on everything">
        ...
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="clothingFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    ...
                    <br>
                    <?php
                        $sql_category = "select subcategory from products where category = 'kids' order by subcategory";
                    ...
                    <a href="../clothing/kids/<?php echo strtolower($uc) . ".php";?>"><?php echo $uc; ?></a><br>
                    <?php }
                        };
                        ?>
                    <br>
