...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where category = 'womens' and subcategory = 'tops'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Womens Tops | Temis Outdoors - Hobby &amp; Supply</title>
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../womens.php">Womens</a></li>
