...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'fishing'
    order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Fishing | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis offers affordable fishing gear and fishing supplies at affordable prices - FREE shipping and returns on everything'>
    ...
    <div class="container products">
            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Fishing</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="container w-20 float-left d-none d-lg-block">
            <div class="filterSidebar">
                <form id="fishingFilters" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                    <h3>Refine Results</h3>
                    <br>
                    <label for="category">Category</label>
                    <br>
                    <?php
                        $sql_category = "select category from products where section = 'fishing' order by category";
                    ...
                    <a href="fishing/<?php echo strtolower($ucURL) . ".php";?>"><?php echo $uc; ?></a><br>
                    <?php }
                        };
                        ?>
                    <br>
