...
$sql = "select * from products where section = 'gardening' and 
category = 'pots and planters' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'gardening' and category = 'pots and planters'
order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <title>Pots &amp; Planter | Temis Outdoors - Hobby &amp; Supply</title>
    <meta name='description' content='Temis is proud to offer affordable, high-quality pots and planters and other gardening supplies - FREE shipping and returns on everything'>
...
<body>
    ...
    <div class="container products">
            <div class="row">
                <div class="col">
                    <h1>Pots and Planters</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="../gardening.php">Gardening</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Pots and Planters</li>
                        </ol>
                    </nav>
                </div>
            </div>
