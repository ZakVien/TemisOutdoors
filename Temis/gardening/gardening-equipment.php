...
category = 'gardening equipment' and 
...
if(isset($_POST["reset"])){
    ...
    $minPrice = 0;
    $maxPrice = 1000;
    $sql = "select * from products where section = 'gardening' and category = 'gardening equipment'
order by manufacturer, name";
    $stmt1 = $db->prepare($sql);
}
...
<head>
    ...
    <meta name='description' content='Temis is proud to offer affordable, high-quality gardening supplies for your landscaping needs - FREE shipping and returns on everything'>
                ...
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Gardening Equipment</li>
                        </ol>
                    </nav>
                </div>
            </div>
